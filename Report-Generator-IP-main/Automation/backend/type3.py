...
async def employee_dashboard(request: Request):
    """Employee performance dashboard with visualizations"""
    html_content = """
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <style>
            ...
            .employee-table th { background-color: #6923d0; color: white; }
    ...
    <body>
        ...
        <script>
            let employeeData = [];
            let employeeChart, severityChart;
            ...
            async function analyzeEmployees() {
                ...
                try {
                    const response = await fetch('/type3/analyze-employees/', {
                        method: 'POST',
                        body: formData
                    });
            ...
            function calculatePerformanceScore(emp) {
                // Performance score based on finding critical/high severity issues
